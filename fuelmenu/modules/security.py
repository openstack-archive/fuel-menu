...
class security(object):
    def __init__(self, parent):
        ...
        # default settings
        try:
            ssh_network = self.parent.settings["ADMIN_NETWORK"]["ssh_network"]
        except KeyError:
    ...
    def apply(self, args):
        ...
        if ssh_network is False:
            ...
            return False
        self.save(ssh_network)

    def save(self, ssh_network):
        newsettings = {'ADMIN_NETWORK': {
    ...
    def load(self):
        modulehelper.ModuleHelper.load_to_defaults(
            self.parent.settings, self.defaults)
