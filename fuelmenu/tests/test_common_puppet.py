...
from fuelmenu.common.puppet import puppetApply
from mock import patch
import unittest


@patch('fuelmenu.common.puppet.logging')
@patch('fuelmenu.common.puppet.execute', return_value=(0, 'Success', 0))
class TestPuppetApply(unittest.TestCase):
    ...
    def test_puppet_apply(self, m_execute, m_log):
        self.assertEqual(puppetApply(self.classes), None)
    ...
    def test_incorrect_type(self, m_execute, m_log):
        ...
        self.assertEqual(puppetApply(self.classes), False)
